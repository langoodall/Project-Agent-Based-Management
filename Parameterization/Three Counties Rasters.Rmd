...
values(SOM1surfC) <- ifelse(is.na(values(SOM1soilC)), 1, values(SOM1surfC))
values(SOM1surfC) <- ifelse(values(SOM1soilC) == 0, 1, values(SOM1surfC))
values(SOM1surfN) <- ifelse(is.na(values(SOM1soilC)), 1, values(SOM1surfN))
values(SOM1surfN) <- ifelse(values(SOM1soilN) == 0, 1, values(SOM1surfN))
values(SOM1soilC) <- ifelse(is.na(values(SOM1soilC)), 1.1, values(SOM1soilC))
values(SOM1soilC) <- ifelse(values(SOM1soilC) == 0, 1.1, values(SOM1soilC))
values(SOM1soilN) <- ifelse(is.na(values(SOM1soilN)), 1.1, values(SOM1soilN))
values(SOM1soilN) <- ifelse(values(SOM1soilN) == 0, 1.1, values(SOM1soilN))
values(SOM2C) <- ifelse(is.na(values(SOM2C)), 1.1, values(SOM2C))
values(SOM2C) <- ifelse(values(SOM2C) == 0, 1.1, values(SOM2C))
values(SOM2N) <- ifelse(is.na(values(SOM2N)), 0.1, values(SOM2N))
values(SOM2N) <- ifelse(values(SOM2N) == 0, 0.1, values(SOM2N))
values(SOM3C) <- ifelse(is.na(values(SOM3C)), 1.1, values(SOM3C))
values(SOM3C) <- ifelse(values(SOM3C) == 0, 1.1, values(SOM3C))
values(SOM3N) <- ifelse(is.na(values(SOM3N)), 0.1, values(SOM3N))
values(SOM3N) <- ifelse(values(SOM3N) == 0, 0.1, values(SOM3N))

writeRaster(SOM1surfC,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/SOM1surfC.tif",
            datatype = "FLT4S",
            NAflag = 0.1,
            overwrite = TRUE)
writeRaster(SOM1surfN,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/SOM1surfN.tif",
            datatype = "FLT4S",
            NAflag = 0.1,
            overwrite = TRUE)
writeRaster(SOM1soilC,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/SOM1soilC.tif",
            datatype = "FLT4S",
            NAflag = 1.1,
            overwrite = TRUE)
writeRaster(SOM1soilN,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/SOM1soilN.tif",
            datatype = "FLT4S",
            NAflag = 0.1,
            overwrite = TRUE)
writeRaster(SOM2C,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/SOM2C.tif",
            datatype = "FLT4S",
            NAflag = 1.1,
            overwrite = TRUE)
writeRaster(SOM2N,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/SOM2N.tif",
            datatype = "FLT4S",
            NAflag = 0.1,
            overwrite = TRUE)
writeRaster(SOM3C,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/SOM3C.tif",
            datatype = "FLT4S",
            NAflag = 1.1,
            overwrite = TRUE)
writeRaster(SOM3N,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/SOM3N.tif",
            datatype = "FLT4S",
            NAflag = 0.1,
            overwrite = TRUE)
...
writeRaster(cwdRast,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/CWD.tif",
            datatype = "FLT4S",
            NAflag = 0,
            overwrite = TRUE)
...
# Corrections needed for the rasters to run

```{r}
# Soil Depth
values(soilDepthRast) <- ifelse(values(soilDepthRast) == 0, 1, values(soilDepthRast))
writeRaster(soilDepthRast,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/SoilDepth.tif",
            datatype = "FLT4S",
            NAflag = 1,
            overwrite = TRUE)
plot(soilDepthRast)
...
# Field Capacity
values(fieldCapacityRast) <- ifelse(values(fieldCapacityRast) == 0, 0.1, values(fieldCapacityRast))
writeRaster(fieldCapacityRast,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/FieldCapacity.tif",
            datatype = "FLT4S",
            NAflag = 0.1,
            overwrite = TRUE)
plot(fieldCapacityRast)
...
```{r}
treeMapTC <- rast("C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/TCTreeMap.tif")

writeRaster(treeMapTC,
            "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/treeMapTC.tif",
            datatype = "INT4S",
            NAflag = 0,
            overwrite = TRUE)
...
x <- rast("C:/Users/lagoodal/Desktop/Dissertation Stuff/Clipped Test/treeMap Resistance/Clipped Piedmont/finalTreeMap.tif")
datatype(x)
```
